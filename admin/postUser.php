...
$stmt = $con->prepare("select user.first_name , user.last_name ,
post_log.id , post_log.content , user.email,
post_log.date_share from post_log
left JOIN user on post_log.user = user.id where user.id is not null
");
$stmt->execute();
$post_log = $stmt->fetchAll(PDO::FETCH_ASSOC);
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"><?php echo $lang['dataTables'] . ' ' . translate('posts',$from , $to) ?></h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    ?>
                                        <tbody id="row-<?php echo $id ?>">
                                            <tr>
                                                ...
                                                <th><a href="../userProfile.php?email=<?php echo $row['email']; ?>"><?php echo $row['first_name'] . ' ' . $row['last_name']; ?></a></th>
